...
\begin{array}{rc}
    ...
    0.33,&\mbox{se}\quad S \geq \frac{1}{6} ou S < \frac{3}{6}      \\
    0.66,&\mbox{se}\quad S \geq \frac{3}{6} ou S < \frac{5}{6}      \\
...
\begin{array}{rc}
    ...
    0.33,&\mbox{se}\quad I \geq \frac{1}{6} ou I < \frac{3}{6}      \\
    0.66,&\mbox{se}\quad I \geq \frac{3}{6} ou I < \frac{5}{6}      \\
...
\begin{array}{rc}
    ...
    0.33,&\mbox{se}\quad V \geq \frac{1}{6} ou V < \frac{3}{6}      \\
    0.66,&\mbox{se}\quad V \geq \frac{3}{6} ou V < \frac{5}{6}      \\
       1,&\mbox{se}\quad V \geq \frac{5}{6}
\end{array}\right.
\end{equation}

A Figura \ref{fig:reduzirHSeV} ilustra a aplicação das equações \ref{eq:reduzirHpara3}, \ref{eq:reduzirS} e \ref{eq:reduzirV}.
...
Os resultados obtidos com as Equações \ref{eq:reduzirHpara3}, \ref{eq:reduzirHpara6} e \ref{eq:reduzirHpara12} não foram satisfatórios. 
