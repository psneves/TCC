...
\caption{Resultado do deslocando dos valores próximos a $35^o$ e limitando os valores de saturação e valor ou intensidade.} \label{fig:figuraHistogramaHSV}
\end{figure}

\begin{figure}[!htb]
\centering \includegraphics[width=0.9\textwidth]{figuraHistograma.png}
\caption{Resultado do deslocando dos valores próximos a $35^o$ e limitando os valores de saturação e valor ou intensidade.} \label{fig:figuraHistogramaHSV2}
\end{figure}

\begin{figure}[!htb]
\centering \includegraphics[width=0.9\textwidth]{figuraHistograma2.png}
\caption{Resultado do deslocando dos valores próximos a $41^o$ e limitando os valores de saturação e valor ou intensidade.} \label{fig:figuraHistogramaHSV2}
\end{figure}

\begin{figure}[!htb]
\centering \includegraphics[width=0.9\textwidth]{figuraHistograma3.png}
\caption{Resultado do deslocando dos valores próximos a $56^o$ e limitando os valores de saturação e valor ou intensidade.} \label{fig:figuraHistogramaHSV3}
\end{figure}

As equações apresentadas limitam as cores, tornando-as mais fácil de identificar as diferenças entre as cores pela maioria dos daltônicos. No entanto, devido a impactante abstração dos sistemas de cores HSV e HSI, muitas características as quais os daltônicos não conseguiam identificar antes do processamento são perdidas, tornando impossível a identificação dessas características em algumas pranchas, até mesmo para pessoas que não são daltônicas.
