...
Foram implementados outros dois processamentos com o objetivo de deslocar os valores da matiz, um com o objetivo de deslocar os valores próximos a $60^o$ e o outro com o objetivo de deslocar os valores próximo a região que mais possui valores, ou seja, o pico do histograma.
...
\begin{figure}[!htb]
\centering \includegraphics[width=0.90\textwidth]{figuraColorsHamarelo.jpg}
